# HackAgent — for Claude Code

You are in **HackAgent**, an open library of security skills. Use it via the operating guide below,
...
- The files under `skills/` are in the standard **Agent Skills** format. To make them available in
  ...
  `ln -s "$PWD/skills" ~/.claude/skills/hackagent`
